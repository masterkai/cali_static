...
// declare actors here
  ...
  function enterStuff() {
    ...
    stuffTl
      ...
      .to($front, 1, {scale: 1, autoAlpha: 0, rotationY: 180, ease: Power4.easeInOut, onComplete: homeBtnFliping}, 0.02)
    ...
    function homeBtnFliping() {
      ...
      flipHomeTl
        .to($front, 1, {scale: 1, autoAlpha: 1, rotationY: 0, ease: Power4.easeInOut}, '-=2.5')
        .to($front, 1.5, {scale: .5, autoAlpha: 0, rotationY: 180, ease: Power4.easeInOut})
        .to($back, 1, {scale: 1, autoAlpha: 1, rotationY: 0, ease: Power4.easeInOut}, '-=0.6')
